...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_teste.cpp, i8* null }]
...
; <label>:12:                                     ; preds = %9
  ...
  %14 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %4, i32 0, i32 0
  %15 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %14, i32 0, i32 0
  store i64 %13, i64* %15, align 8
  %16 = call i32 @_Z1fi(i32 10)
  store i32 %16, i32* %5, align 4
  %17 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #3
  %18 = getelementptr inbounds %"struct.std::chrono::time_point", %"struct.std::chrono::time_point"* %8, i32 0, i32 0
  %19 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %18, i32 0, i32 0
  store i64 %17, i64* %19, align 8
  %20 = call i64 @_ZNSt6chronomiINS_3_V212system_clockENS_8durationIlSt5ratioILl1ELl1000000000EEEES6_EENSt11common_typeIJT0_T1_EE4typeERKNS_10time_pointIT_S8_EERKNSC_ISD_S9_EE(%"struct.std::chrono::time_point"* dereferenceable(8) %8, %"struct.std::chrono::time_point"* dereferenceable(8) %4)
  %21 = getelementptr inbounds %"struct.std::chrono::duration", %"struct.std::chrono::duration"* %7, i32 0, i32 0
  store i64 %20, i64* %21, align 8
  call void @_ZNSt6chrono8durationIdSt5ratioILl1ELl1EEEC2IlS1_ILl1ELl1000000000EEvEERKNS0_IT_T0_EE(%"struct.std::chrono::duration.0"* %6, %"struct.std::chrono::duration"* dereferenceable(8) %7)
  %22 = call double @_ZNKSt6chrono8durationIdSt5ratioILl1ELl1EEE5countEv(%"struct.std::chrono::duration.0"* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_teste.cpp() #0 section ".text.startup" {
