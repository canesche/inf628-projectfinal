...
commands_getoutput('clang++ -std=c++11 -c -emit-llvm %s -o %s' % (file, work_dir + '/out.ll'))

ga = GeneticAlgorithm(100, 100, 0.2, 0.2, MyIndividual, [work_dir, work_dir + '/out.ll', features],
                      work_dir + '/out.csv')
